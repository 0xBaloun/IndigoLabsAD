...
resource "azurerm_network_interface_nat_rule_association" "indigolabs-vm-windows10xdr-nic-nat" {
  network_interface_id  = azurerm_network_interface.indigolabs-vm-windows10xdr-nic.id
  ip_configuration_name = "indigolabs-vm-windows10xdr-config"
